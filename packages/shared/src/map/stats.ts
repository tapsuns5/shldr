...
import { totalDistanceKm } from './arcRoutes';
import type { TravelMapData } from './deriveMapData';
...
/** Mirrors shldr's hooks/useTravelStats.ts (web) as a plain function. */
export function deriveTravelStats(mapData: TravelMapData): TravelStats {
